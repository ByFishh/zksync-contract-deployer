...
const TokenLayout = () => {
  ...
  const handleClick = async () => {
    ...
    const factory = new ContractFactory(tokenContract.abi, tokenContract.bytecode, signer, 'create');

    let contract: Contract;

    setDeploying(true);
    try {
      contract = await factory.deploy(tokenName, tokenSymbol);
  ...
  return (
    <div className="grid place-items-center">
      <h1 className="font-bold text-4xl text-white mb-2">Token</h1>
      <h1 className="text-xl text-white mb-8">~40$ fees</h1>
      <div className="grid place-items-center">
        <div className="mb-6 w-80">
          ...
          <input
            ...
            placeholder="A simple test token"
            required
          />
          <label htmlFor="" className="pt-5 block mb-2 text-sm font-normal text-white">
            Token symbol
          </label>
          <input
            type="text"
